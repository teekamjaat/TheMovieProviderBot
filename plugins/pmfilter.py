...
async def give_filter(client, message):
    if message.chat.id != SUPPORT_CHAT_ID:
        ...
        if total_results == 0:
            ...
            reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("🔍 ᴊᴏɪɴ ᴀɴᴅ ꜱᴇᴀʀᴄʜ ʜᴇʀᴇ 🔎", url=f"https://t.me/all_hdmovierequestgroup")]]))
...
async def pm_text(bot, message):
    ...
    await message.reply_text(
         ...
         reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("📝 ʀᴇǫᴜᴇsᴛ ʜᴇʀᴇ ", url=f"https://t.me/+Us8oEumXt4UzNGNl")]])
    )
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    # Thanks to @CoderluffyTG for fixing this 
        ...
        buttons = [[
            ...
            InlineKeyboardButton('🔍 ɢʀᴏᴜᴘ¹', url='https://t.me/all_hdmovierequestgroup'),
            InlineKeyboardButton('ɢʀᴏᴜᴘ² 🔎', url='https://t.me/all_hdmovierequestgroup')
        ],[
            InlineKeyboardButton('✉️ ʀᴇǫᴜᴇꜱᴛ ɢʀᴏᴜᴘ ✉️', url='https://t.me/+Us8oEumXt4UzNGNl')
        ],[
            InlineKeyboardButton('⇇ ʙᴀᴄᴋ', callback_data='start'),
            InlineKeyboardButton('ꜱᴜᴘᴘᴏʀᴛ 👮', url='https://t.me/teekam_jaat')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
